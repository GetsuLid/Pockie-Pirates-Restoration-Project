package
{
   ...
   public class _Scene_Comp_HangSceneWatcherSetupUtil extends Sprite implements IWatcherSetupUtil
   {
      
      public function _Scene_Comp_HangSceneWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         HangScene.watcherSetupUtil = new _Scene_Comp_HangSceneWatcherSetupUtil();
      }
      ...
      public function setup(param1:Object, param2:Function, param3:Array, param4:Array) : void
      {
         ...
         watchers[45] = new PropertyWatcher("userHide",{"propertyChange":true},[bindings[29]],null);
         watchers[7] = new StaticPropertyWatcher("Silver",{"propertyChange":true},[bindings[4],bindings[8]],null);
         watchers[42] = new StaticPropertyWatcher("ShowOthers",{"propertyChange":true},[bindings[28]],null);
         watchers[39] = new PropertyWatcher("leftTime",{"propertyChange":true},[bindings[27]],propertyGetter);
         watchers[13] = new StaticPropertyWatcher("SeriousFame",{"propertyChange":true},[bindings[10]],null);
         watchers[40] = new FunctionReturnWatcher("getInstance",target,function():Array
         {
            return [];
         },null,[bindings[28]],null);
         watchers[41] = new PropertyWatcher("userHide",{"propertyChange":true},[bindings[28]],null);
         watchers[18] = new StaticPropertyWatcher("inst",{"propertyChange":true},[bindings[32],bindings[13],bindings[30],bindings[33],bindings[22]],null);
         watchers[19] = new PropertyWatcher("isWar",{"propertyChange":true},[bindings[32],bindings[13],bindings[30],bindings[33],bindings[22]],null);
         watchers[46] = new FunctionReturnWatcher("getInstance",target,function():Array
         {
            return [];
         },null,[bindings[31]],null);
         watchers[47] = new PropertyWatcher("sceneName",{"propertyChange":true},[bindings[31]],null);
         ...
         watchers[38] = new PropertyWatcher("needClock",{"propertyChange":true},[bindings[26]],propertyGetter);
         ...
         watchers[43] = new StaticPropertyWatcher("ShowOthers_U",{"propertyChange":true},[bindings[28]],null);
         watchers[0] = new StaticPropertyWatcher("Instance",null,[bindings[15],bindings[4],bindings[19],bindings[8],bindings[23],bindings[11],bindings[16],bindings[18],bindings[3],bindings[7],bindings[12],bindings[22],bindings[17],bindings[2],bindings[9],bindings[21],bindings[6],bindings[1],bindings[20],bindings[14],bindings[10],bindings[5],bindings[0]],null);
