package
{
   ...
   import ui.land.Comp.WareHouseRenderer;
   
   public class _ui_land_Comp_WareHouseRendererWatcherSetupUtil extends Sprite implements IWatcherSetupUtil
   {
      
      public function _ui_land_Comp_WareHouseRendererWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         WareHouseRenderer.watcherSetupUtil = new _ui_land_Comp_WareHouseRendererWatcherSetupUtil();
      }
