package data.hero
{
   ...
   public class AbilityData2 implements IEventDispatcher
   {
      ...
      private function dealXY() : void
      {
         ...
         StaminaX = imgWidth / 2;
         StaminaY = imgHeight / 2 * (1 - percent);
         ...
         IntelligenceX = imgWidth / 2;
         IntelligenceY = imgHeight / 2 * (1 + percent);
      }
