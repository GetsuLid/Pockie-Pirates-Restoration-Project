package
{
   ...
   public class Border_mx_core_FlexModuleFactory extends FlexModuleFactory implements IFlexModuleFactory
   {
      
      public function Border_mx_core_FlexModuleFactory()
      {
         super();
      }
      ...
      override public function create(... rest) : Object
      {
         ...
         var _loc2_:String = rest.length == 0 ? "Border" : String(rest[0]);
