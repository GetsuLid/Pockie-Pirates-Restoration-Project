package
{
   ...
   public class Other_mx_core_FlexModuleFactory extends FlexModuleFactory implements IFlexModuleFactory
   {
      
      public function Other_mx_core_FlexModuleFactory()
      {
         super();
      }
      ...
      override public function create(... rest) : Object
      {
         ...
         var _loc2_:String = rest.length == 0 ? "Other" : String(rest[0]);
