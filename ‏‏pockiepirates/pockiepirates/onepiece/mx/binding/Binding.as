package mx.binding
{
   ...
   public class Binding
   {
      ...
      private function innerExecute() : void
      {
         ...
         {
            if(!(lastValue is XML && Boolean(lastValue.hasComplexContent()) && lastValue === value) && !(lastValue is XMLList && lastValue.hasComplexContent() && value is XMLList && nodeSeqEqual(lastValue as XMLList,value as XMLList)))
            {
