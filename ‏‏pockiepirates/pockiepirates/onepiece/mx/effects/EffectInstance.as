package mx.effects
{
   ...
   public class EffectInstance extends EventDispatcher implements IEffectInstance
   {
      ...
      {
         if(Boolean(delayTimer) && Boolean(!delayTimer.running) && !isNaN(delayElapsedTime))
         {
      ...
      {
         if(!durationExplicitlySet && Boolean(parentCompositeEffectInstance))
         {
      ...
      {
         if(Boolean(delayTimer) && Boolean(delayTimer.running) && !isNaN(delayStartTime))
         {
            delayTimer.stop();
