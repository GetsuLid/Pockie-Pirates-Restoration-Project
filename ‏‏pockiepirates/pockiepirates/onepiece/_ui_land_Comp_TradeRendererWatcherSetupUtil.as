package
{
   ...
   public class _ui_land_Comp_TradeRendererWatcherSetupUtil extends Sprite implements IWatcherSetupUtil
   {
      
      public function _ui_land_Comp_TradeRendererWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         TradeRenderer.watcherSetupUtil = new _ui_land_Comp_TradeRendererWatcherSetupUtil();
      }
