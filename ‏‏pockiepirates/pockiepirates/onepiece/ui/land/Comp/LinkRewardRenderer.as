package ui.land.Comp
{
   ...
   public class LinkRewardRenderer extends Canvas implements IBindingClient
   {
      ...
      public var _LinkRewardRenderer_SWFLoader1:SWFLoader;
      
      public var _LinkRewardRenderer_SWFLoader2:SWFLoader;
      
      mx_internal var _watchers:Array = [];
      
      mx_internal var _bindingsByDestination:Object = {};
      
      public var _LinkRewardRenderer_GlowLabel1:GlowLabel;
      
      public var _LinkRewardRenderer_Canvas3:Canvas;
      
      private var _3242771item:ItemBase;
      
      public var _LinkRewardRenderer_Image1:Image;
               ...
               "childDescriptors":[new UIComponentDescriptor({
                  ...
                  "propertiesFactory":function():Object
                  {
                     return {
                        ...
                        "childDescriptors":[new UIComponentDescriptor({
                           "type":SWFLoader,
                           "id":"_LinkRewardRenderer_SWFLoader1",
                           "propertiesFactory":function():Object
                           {
                              return {
                                 "width":40,
                           ...
                           "type":SWFLoader,
                           "id":"_LinkRewardRenderer_SWFLoader2",
                           "propertiesFactory":function():Object
                           {
                              return {
                                 "x":1,
                           ...
                           "type":GlowLabel,
                           "id":"_LinkRewardRenderer_GlowLabel1",
                  ...
                  "type":Canvas,
                  "id":"_LinkRewardRenderer_Canvas3",
                  "propertiesFactory":function():Object
                  {
                     return {
                        "width":46,
      ...
      public function LinkRewardRenderer()
      {
         super();
         mx_internal::_document = this;
         this.width = 46;
         this.height = 46;
         this.addEventListener("dataChange",___LinkRewardRenderer_Canvas1_dataChange);
         this.addEventListener("mouseOver",___LinkRewardRenderer_Canvas1_mouseOver);
         this.addEventListener("mouseOut",___LinkRewardRenderer_Canvas1_mouseOut);
      }
      
      public static function set watcherSetupUtil(param1:IWatcherSetupUtil) : void
      {
         LinkRewardRenderer._watcherSetupUtil = param1;
      }
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:LinkRewardRenderer = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _LinkRewardRenderer_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_ui_land_Comp_LinkRewardRendererWatcherSetupUtil");
      ...
      public function ___LinkRewardRenderer_Canvas1_mouseOut(event:MouseEvent) : void
      {
         rollOut(event);
      }
      
      public function ___LinkRewardRenderer_Canvas1_mouseOver(event:MouseEvent) : void
      {
         rollOver(event);
      }
      ...
      private function _LinkRewardRenderer_bindingExprs() : void
      {
         ...
         _loc1_ = item.count > 0 && !item.isntItem;
         _loc1_ = isNoHole;
      ...
      public function ___LinkRewardRenderer_Canvas1_dataChange(event:FlexEvent) : void
      {
         onDataChange();
      }
      ...
      private function _LinkRewardRenderer_bindingsSetup() : Array
      {
         ...
         {
            _LinkRewardRenderer_SWFLoader1.source = param1;
         },"_LinkRewardRenderer_SWFLoader1.source");
         result[0] = binding;
         ...
         {
            _LinkRewardRenderer_SWFLoader1.visible = param1;
         },"_LinkRewardRenderer_SWFLoader1.visible");
         result[1] = binding;
         binding = new Binding(this,function():Object
         {
         ...
         {
            _LinkRewardRenderer_SWFLoader2.source = param1;
         },"_LinkRewardRenderer_SWFLoader2.source");
         result[2] = binding;
         ...
         {
            _LinkRewardRenderer_GlowLabel1.text = param1;
         },"_LinkRewardRenderer_GlowLabel1.text");
         result[3] = binding;
         ...
         {
            _LinkRewardRenderer_GlowLabel1.setStyle("color",param1);
         },"_LinkRewardRenderer_GlowLabel1.color");
         result[4] = binding;
         binding = new Binding(this,function():Boolean
         {
            return item.count > 0 && !item.isntItem;
         },function(param1:Boolean):void
         {
            _LinkRewardRenderer_GlowLabel1.visible = param1;
         },"_LinkRewardRenderer_GlowLabel1.visible");
         result[5] = binding;
         binding = new Binding(this,function():Boolean
         {
            return isNoHole;
         ...
         {
            _LinkRewardRenderer_Image1.visible = param1;
         },"_LinkRewardRenderer_Image1.visible");
         result[6] = binding;
         binding = new Binding(this,function():Boolean
         {
         ...
         {
            _LinkRewardRenderer_Canvas3.visible = param1;
         },"_LinkRewardRenderer_Canvas3.visible");
         result[7] = binding;
         return result;
      }
   }
