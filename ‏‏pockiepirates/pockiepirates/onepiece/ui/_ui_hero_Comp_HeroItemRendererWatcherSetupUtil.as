package
{
   ...
   public class _ui_hero_Comp_HeroItemRendererWatcherSetupUtil extends Sprite implements IWatcherSetupUtil
   {
      
      public function _ui_hero_Comp_HeroItemRendererWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         HeroItemRenderer.watcherSetupUtil = new _ui_hero_Comp_HeroItemRendererWatcherSetupUtil();
      }
