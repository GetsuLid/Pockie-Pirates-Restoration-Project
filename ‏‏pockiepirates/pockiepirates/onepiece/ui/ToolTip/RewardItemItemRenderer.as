package ToolTip
{
   ...
   public class RewardItemItemRenderer extends Canvas implements IBindingClient
   {
      
      private static var _watcherSetupUtil:IWatcherSetupUtil;
      
      public var _RewardItemItemRenderer_SWFLoader1:SWFLoader;
      
      public var _RewardItemItemRenderer_SWFLoader2:SWFLoader;
      
      mx_internal var _bindingsBeginWithWord:Object = {};
      
      private var _1180113065isSuit:Boolean;
      
      public var _RewardItemItemRenderer_GlowLabel1:GlowLabel;
      
      mx_internal var _watchers:Array = [];
      
      mx_internal var _bindingsByDestination:Object = {};
      
      public var _RewardItemItemRenderer_Image1:Image;
      ...
      public var _RewardItemItemRenderer_Canvas3:Canvas;
               ...
               "childDescriptors":[new UIComponentDescriptor({
                  ...
                  "propertiesFactory":function():Object
                  {
                     return {
                        ...
                        "childDescriptors":[new UIComponentDescriptor({
                           "type":SWFLoader,
                           "id":"_RewardItemItemRenderer_SWFLoader1",
                           "propertiesFactory":function():Object
                           {
                              return {
                                 "width":40,
                           ...
                           "type":SWFLoader,
                           "id":"_RewardItemItemRenderer_SWFLoader2",
                           "propertiesFactory":function():Object
                           {
                              return {
                                 "x":1,
                           ...
                           "type":GlowLabel,
                           "id":"_RewardItemItemRenderer_GlowLabel1",
                           "stylesFactory":function():void
                           {
                              this.fontSize = 10;
                              this.right = "5";
                           ...
                           "type":Image,
                           "id":"_RewardItemItemRenderer_Image1",
                           "propertiesFactory":function():Object
                           {
                              return {
                  ...
                  "type":Canvas,
                  "id":"_RewardItemItemRenderer_Canvas3",
                  "stylesFactory":function():void
                  {
                     this.horizontalCenter = "0";
                  },
      ...
      public function RewardItemItemRenderer()
      {
         super();
         mx_internal::_document = this;
         this.width = 60;
         this.height = 50;
         this.addEventListener("dataChange",___RewardItemItemRenderer_Canvas1_dataChange);
         this.addEventListener("rollOver",___RewardItemItemRenderer_Canvas1_rollOver);
         this.addEventListener("rollOut",___RewardItemItemRenderer_Canvas1_rollOut);
      }
      
      public static function set watcherSetupUtil(param1:IWatcherSetupUtil) : void
      {
         RewardItemItemRenderer._watcherSetupUtil = param1;
      }
      ...
      private function _RewardItemItemRenderer_bindingsSetup() : Array
      {
         ...
         {
            _RewardItemItemRenderer_SWFLoader1.source = param1;
         },"_RewardItemItemRenderer_SWFLoader1.source");
         result[0] = binding;
         ...
         {
            _RewardItemItemRenderer_SWFLoader1.visible = param1;
         },"_RewardItemItemRenderer_SWFLoader1.visible");
         result[1] = binding;
         binding = new Binding(this,function():Object
         {
         ...
         {
            _RewardItemItemRenderer_SWFLoader2.source = param1;
         },"_RewardItemItemRenderer_SWFLoader2.source");
         result[2] = binding;
         ...
         {
            _RewardItemItemRenderer_GlowLabel1.text = param1;
         },"_RewardItemItemRenderer_GlowLabel1.text");
         result[3] = binding;
         ...
         {
            _RewardItemItemRenderer_GlowLabel1.setStyle("color",param1);
         },"_RewardItemItemRenderer_GlowLabel1.color");
         result[4] = binding;
         binding = new Binding(this,function():Boolean
         {
            return item.count != 1 && !isSuit || Boolean(item.isRise);
         },function(param1:Boolean):void
         {
            _RewardItemItemRenderer_GlowLabel1.visible = param1;
         },"_RewardItemItemRenderer_GlowLabel1.visible");
         result[5] = binding;
         binding = new Binding(this,function():Boolean
         {
            return isNoHole;
         ...
         {
            _RewardItemItemRenderer_Image1.visible = param1;
         },"_RewardItemItemRenderer_Image1.visible");
         result[6] = binding;
         binding = new Binding(this,function():Boolean
         {
         ...
         {
            _RewardItemItemRenderer_Canvas3.visible = param1;
         },"_RewardItemItemRenderer_Canvas3.visible");
         result[7] = binding;
         return result;
      }
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:RewardItemItemRenderer = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _RewardItemItemRenderer_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_ToolTip_RewardItemItemRendererWatcherSetupUtil");
      ...
      private function _RewardItemItemRenderer_bindingExprs() : void
      {
      ...
      public function ___RewardItemItemRenderer_Canvas1_rollOut(event:MouseEvent) : void
      {
         rollOut(event);
      }
      ...
      public function ___RewardItemItemRenderer_Canvas1_rollOver(event:MouseEvent) : void
      {
         rollOver(event);
      }
      ...
      public function ___RewardItemItemRenderer_Canvas1_dataChange(event:FlexEvent) : void
      {
         onDataChange();
      }
