package
{
   ...
   public class _SWFLoaderStyle
   {
      ...
      private static var _embed_css_Assets_swf___brokenImage_1423187617:Class = _SWFLoaderStyle__embed_css_Assets_swf___brokenImage_1423187617;
      ...
      public static function init(param1:IFlexModuleFactory) : void
      {
         ...
         if(style.defaultFactory == null)
         {
            ...
            {
               this.brokenImageSkin = _embed_css_Assets_swf___brokenImage_1423187617;
